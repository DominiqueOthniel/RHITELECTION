...
-- Total: ~225 étudiants dans le PDF, ~155 dans la base actuelle = ~70 étudiants manquants
...
VALUES
  -- Étudiants manquants identifiés depuis le PDF complet
  ...
  (generate_voter_id(), '2025158', 'ALAIN STEVE SOSSO KINGUE', generate_vote_code(), false, '1ère année', 'Business Management', NOW()),
  (generate_voter_id(), '2025159', 'ALEXANDER ONUHA FRANKLIN NICK', generate_vote_code(), false, '1ère année', 'Accountancy', NOW()),
  ...
  (generate_voter_id(), '2025173', 'EDDY ANTOINE DAVID TOUTOU DIDI BISSA', generate_vote_code(), false, '1ère année', 'Business/Project Management', NOW()),
  ...
  (generate_voter_id(), '2025193', 'LENGONO ELOUNDOU MARIETTE LARISSA', generate_vote_code(), false, '3ème année', 'Computer Engineering', NOW()),
  ...
  (generate_voter_id(), '2025212', 'SIHNO HOUETO MAGLOIRE ESPOIR KEVIN', generate_vote_code(), false, '1ère année', 'Computer and Electronics Engineering', NOW()),
  ...
  (generate_voter_id(), '2025220', 'VICTORINE NKOME NDJEM LAFLEURE', generate_vote_code(), false, '1ère année', 'Software Engineering', NOW()),
  (generate_voter_id(), '2025221', 'WAMBA LATIFA', generate_vote_code(), false, '3ème année', 'Electrical Engineering', NOW()),
  (generate_voter_id(), '2025222', 'WATAT WATAT DYLAN JORDAN', generate_vote_code(), false, '1ère année', 'Business/Project Management', NOW()),
