...
-- Nécessaire pour que le client (clé anon) puisse appeler ces RPC depuis le navigateur.
-- Sans ces GRANT, la connexion échoue ou bascule sur un fallback fragile.
